...
(* OASIS_START *)
(* DO NOT EDIT (digest: 1c5451d55251d8cfaa7fa4d2e7d7365f) *)
(*
...
let setup_t =
  {
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("rpclib", None);
                           FindlibPackage ("rpclib.syntax", None);
                           FindlibPackage ("rpclib.idl", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
     ...
     oasis_version = "0.4.2";
     oasis_digest = Some "\001\164\138\185h\216\179v_ 2\241\165~\192\153";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
